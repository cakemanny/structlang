    ...
    switch (exp->te_tag) {
        ...
        case TREE_EXP_BINOP:
        {
            switch (exp->te_binop) {
                ...
                {
                    // BINOP(PLUS(e1, CONST) // TODO
                    // BINOP(PLUS(CONST, e1) // TODO
                    ...
                    var src_list = temp_list(Munch_exp(exp->te_rhs));
                    emit(state,
                         assm_oper(s, temp_list(r), src_list, NULL));
                    return r;
                }
...
#define Munch_exp(_exp) munch_exp(state, _exp)
    ...
    switch (stm->tst_tag) {
        ...
        case TREE_STM_CJUMP:
        {
            // TODO: CJUMP(==, e1, CONST i, Ltrue, Lfalse)
